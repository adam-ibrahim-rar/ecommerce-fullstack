...
import type { CartItem } from "../../reduxtoolkit/slices/cart/CartTypes";
  ...
  return (
    <div className="h-[102px] shadow-lg inset-shadow-xs select-none w-full px-10 grid grid-cols-4 items-center">
      ...
      <div className="flex justify-center">
        <div className="w-[66px] h-[42px] border border-gray-400 flex justify-around items-center rounded-md">
