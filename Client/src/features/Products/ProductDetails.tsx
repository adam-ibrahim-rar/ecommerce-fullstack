    ...
    <div className="w-[1170px] mx-auto flex mb-18 justify-between">
        ...
        <div className="w-[170px] h-[600px] flex flex-col justify-between">
          {product.images.map((image, index) => (
            <button
              ...
              className="w-[170px] h-[138px] bg-gray-100 flex items-center justify-center cursor-pointer rounded overflow-hidden"
            >
              <img
                src={image}
                alt={product.title}
      ...
      <div className="w-[400px] justify-between h-[600px] flex flex-col">
        <div className="gap-3 flex flex-col">
          <h1 className="text-[24px] font-semibold leading-6">{product.title}</h1>
