    ...
    <div className="w-[1170px] mx-auto">
      ...
      <div className="grid grid-cols-3 gap-5 mt-14">
        {Array.from({ length: 3 }).map((_, index) => (
          <div
            key={index}
            className="h-[564px] gap-8"
          >
            <Skeleton
              ClassName="w-full h-[430px] rounded-none"
            />
      ...
      <div className="w-[943px] h-[161px] mx-auto flex justify-between">
        {Array.from({ length: 3 }).map((_, index) => (
          ...
          >
            ...
            <Skeleton
              ClassName="w-[210px] h-[20px] rounded"
            />

            
            <Skeleton
              ClassName="w-[220px] h-[18px] rounded mt-2"
            />
          </div>
        ))}
      </div>
  ...
  return (
    ...
    >
      <div className="w-full h-[170px] flex flex-col items-center justify-center gap-2">
        ...
        {/* Number */}
        <Skeleton
          ClassName="w-[100px] h-[38px] rounded"
        />

        {/* Description */}
        <Skeleton
          ClassName="w-[190px] h-[24px] rounded"
        />
      </div>
    </div>
  );
